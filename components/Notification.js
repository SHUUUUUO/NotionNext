...
const useNotification = () => {
  ...
  const Notification = () => {
    return (
      <div className={`notification fixed left-0 w-full px-2 z-30 bottom-14 pointer-events-none`}>
        <div
          className={` ${isVisible && message ? 'opacity-100 pointer-events-auto' : 'invisible opacity-0 pointer-events-none'} transition-opacity duration-200 
