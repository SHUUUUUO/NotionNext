...
export const MenuItemDrop = ({ link }) => {
  ...
  return (
    <li
      ...
      {hasSubMenu && (
        <ul
          className={`${show ? 'visible opacity-100 translate-y-0' : 'invisible opacity-0 -translate-y-2'} z-20 p-2 absolute left-0 top-full mt-2 min-w-[10rem] border border-gray-100 bg-white dark:bg-black dark:border-gray-800 transition-all duration-200 rounded-lg`}>
