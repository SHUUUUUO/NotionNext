...
const TopBar = ({ height, style, children }) => {
  ...
  return (
    <>
      {/* 固定顶栏（仅桌面显示） */}
      <div
        className="hidden lg:flex w-full fixed top-0 left-0 z-50 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-700 items-center transition-all duration-300"
        style={{
          height: barHeight,
      ...
      >
        <div className="flex-1 flex items-center px-6 h-full max-w-5xl mx-auto">
